...
from TAX_LSTM.gamallo_fernandez_2023_context_based_representations.src.embeddings_generator.logger import \
    EmbGeneratorLogger
from TAX_LSTM.gamallo_fernandez_2023_context_based_representations.src.embeddings_generator.pandas_dataset import \
    EventlogDataset
from TAX_LSTM.gamallo_fernandez_2023_context_based_representations.src.embeddings_generator.utils import \
